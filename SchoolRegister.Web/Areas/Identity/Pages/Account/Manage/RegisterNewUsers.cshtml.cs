...
namespace SchoolRegister.Web.Areas.Identity.Pages.Account.Manage
{
    ...
    public class RegisterNewUsersDataModel : PageModel
    {
        ...
        private readonly ApplicationDbContext _dbContext;[BindProperty]
        ...
        public IActionResult OnGet()
        {
            ...
            ViewData["Groups"] = new SelectList(_dbContext.Groups.Select(t => new
            {
                Text = t.Name,
                Value = t.Id
            }), "Value", "Text"); ViewData["Parents"] = new SelectList(_dbContext.Users.OfType<Parent>().Select(t => new
            {
        ...
        { 
            ...
            { 
                ...
                { 
                    ...
                    if (result.Succeeded) 
                    { 
                        OnGet(); StatusMessage = "User created"; 
        ...
        { 
            ...
            { 
                ...
                case RoleValue.Admin: case RoleValue.User: 
